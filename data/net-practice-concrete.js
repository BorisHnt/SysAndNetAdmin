window.NET_PRACTICE_CONCRETE = {
  "01": {
    ...
    deductions: [
      {
        look: "PC A vaut 104.96.23.13/24.",
        meaning: "Le /24 conserve les trois premiers octets pour le réseau.",
        deduction: "Le réseau est 104.96.23.0/24 et les hôtes vont de .1 à .254.",
        value: "PC B = 104.96.23.42/24.",
        why: ".42 est libre, n’est ni le réseau .0 ni le broadcast .255, et reste dans le même /24."
      },
      {
        look: "PC D vaut 211.191.65.76/16.",
        ...
        value: "PC C = 211.191.80.42/16.",
        why: "L’adresse est différente de D et appartient au réseau 211.191.0.0/16."
      }
    ],
    beginnerFocus: [
      {
        ...
        steps: [
          ...
          "104.96.23.42/24 et 104.96.23.13/24 donnent tous les deux le réseau 104.96.23.0/24.",
        ...
        result: "A1 : 104.96.23.13/24\nB1 : 104.96.23.42/24\nRéseau commun : 104.96.23.0/24"
      },
      {
        ...
        steps: [
          ...
          "211.191.65.76 et 211.191.80.42 sont donc voisines malgré leurs deux derniers nombres différents."
        ],
        result: "C1 : 211.191.80.42/16\nD1 : 211.191.65.76/16\nRéseau commun : 211.191.0.0/16"
      }
    ],
    solution: "A 104.96.23.13/24 <-> B 104.96.23.42/24\nC 211.191.80.42/16 <-> D 211.191.65.76/16",
    packet: [
  ...
  "02": {
    ...
    deductions: [
      {
        look: "PC B vaut 192.168.130.222/27.",
    ...
    beginnerFocus: [
      {
        ...
        result: "Réseau : 192.168.130.192/27\nA1 : 192.168.130.193\nB1 : 192.168.130.222"
      },
      {
    ...
    solution: "A 192.168.130.193/27 <-> B 192.168.130.222/27\nC 10.10.10.1/30 <-> D 10.10.10.2/30",
    ...
    beginnerFocus: [
      {
        ...
        result: "Réseau commun : 104.198.76.0/25\nA1 : .125\nB1 : .42\nC1 : .126"
      }
    ],
    solution: "A 104.198.76.125/25\nB 104.198.76.126/25\nC 104.198.76.120/25",
  ...
  "04": {
    ...
    deductions: [
      ...
      },
      {
        ...
        value: "A : 0.0.0.0/0 via 73.53.112.129.",
    ...
    beginnerFocus: [
      {
        ...
        result: "Réseau : 73.53.112.128/28\nR1 : 73.53.112.129\nB1 : 73.53.112.130\nA1 : 73.53.112.132"
      }
    ],
    solution: "A = 73.53.112.132/28\nR1 = 73.53.112.129/28\nRoute A = 0.0.0.0/0 via 73.53.112.129",
  ...
  "05": {
    ...
    deductions: [
      {
        look: "R1 vaut 76.5.75.126/25.",
        meaning: "R1 appartient au réseau 76.5.75.0/25.",
        deduction: "A doit être entre .1 et .125, hors adresses déjà prises.",
        value: "A = 76.5.75.125/25 ; gateway = 76.5.75.126.",
        why: "A et R1 sont voisins dans le même LAN."
      },
      {
        look: "R2 vaut 144.197.75.254/18.",
        meaning: "Avec /18, le troisième octet avance par 64 ; 130 tombe dans 128-191.",
        deduction: "Le réseau est 144.197.64.0/18.",
        value: "B = 144.197.75.253/18 ; gateway = 144.197.75.254.",
    ...
    beginnerFocus: [
      {
        ...
        steps: [
          "R1 vaut 76.5.75.126/25. A1 doit donc être dans 76.5.75.0-.127.",
          "R2 vaut 144.197.75.254/18. Avec /18, le troisième nombre avance par blocs de 64.",
          "130 tombe dans le bloc 128-191 : le réseau de B est 144.197.64.0/18.",
          "A utilise R1 comme gateway. B utilise R2. Une machine ne choisit jamais l’interface située de l’autre côté du routeur."
        ],
        result: "LAN A : 76.5.75.0/25\nA1 .125 -> R1 .126\n\nLAN B : 144.197.64.0/18\nB1 144.197.75.253 -> R2 144.197.75.254"
      }
    ],
    solution: "A 76.5.75.125/25 -> gateway 76.5.75.126\nB 144.197.75.253/18 -> gateway 144.197.75.254",
  ...
  "07": {
    ...
    rules: ["Deux interfaces reliées par un câble doivent partager un réseau.", "Deux câbles différents ne doivent pas partager le même sous-réseau.", "Le tirage JSON utilise ici des /28 : chaque lien a donc plus d’adresses que nécessaire, mais reste dans son propre bloc."],
    deductions: [
      {
        look: "R1 côté A vaut 93.198.14.1.",
        meaning: "On cherche le réseau /28 contenant 93.198.14.1.",
        deduction: "Le bloc 93.198.14.0 à 93.198.14.15 contient les hôtes .1 à .14.",
        value: "R1 = 93.198.14.1/28 ; A = 93.198.14.2/28.",
        why: "Les deux interfaces sont voisines dans le même bloc /28."
      },
      {
        look: "Le transit impose une extrémité .254.",
        meaning: ".254 appartient au bloc /28 .240-.255.",
        deduction: "Les hôtes disponibles vont de .241 à .254.",
        value: "R1 = 93.198.14.254/28 ; R2 = 93.198.14.253/28.",
      ...
      },
      {
        ...
        deduction: "Le bloc 1.2.3.240/28 est indépendant des deux précédents.",
        value: "R2 = 1.2.3.252/28 ; C = 1.2.3.253/28.",
        why: "R2 et C partagent ce troisième réseau sans chevauchement."
      }
    ],
    beginnerFocus: [
      {
        title: "Pourquoi utiliser /28 sur ces trois câbles ?",
        intro: "Chaque câble ne relie que deux interfaces. Un /30 suffirait en théorie, mais ce tirage NetPractice impose des masques /28 à corriger autour des valeurs données.",
        steps: [
          "Un /28 contient 16 adresses : une adresse réseau, 14 hôtes et un broadcast.",
          "Le câble A1-R11 utilise 93.198.14.0-.15 : .1 et .2 sont deux hôtes valides.",
          "Le câble R12-R21 utilise 93.198.14.240-.255 : .253 et .254 sont deux hôtes valides.",
          "Le câble R22-C1 utilise 1.2.3.240-.255 : .252 et .253 sont deux hôtes valides.",
          "Les trois câbles ont des blocs différents, donc les routeurs savent par quelle interface sortir."
        ],
        result: "A1-R11 : 93.198.14.0/28\nR12-R21 : 93.198.14.240/28\nR22-C1 : 1.2.3.240/28"
      }
    ],
    solution: "A 93.198.14.2/28 <-> R1 93.198.14.1/28\nR1 93.198.14.254/28 <-> R2 93.198.14.253/28\nR2 1.2.3.252/28 <-> C 1.2.3.253/28\nA default via 93.198.14.1\nR1 default via 93.198.14.253\nR2 default via 93.198.14.254\nC default via 1.2.3.252",
    packet: ["A -> R1 par le LAN gauche.", "R1 -> R2 par le transit.", "R2 -> C par le LAN droit.", "Le retour utilise les routes symétriques vers A."],
    traps: ["Réutiliser le même /28 sur deux liens.", "Oublier une route sur l’un des routeurs.", "Utiliser .240 ou .255 sur le transit 93.198.14.240/28."]
  },
  "08": {
  ...
  "09": {
    ...
    deductions: [
      {
        look: "A et B partagent le LAN 42.5.4.0/25.",
        ...
        value: "A = 42.5.4.2/25 ; B = 42.5.4.3/25 ; gateway = 42.5.4.1.",
        why: "Les trois interfaces sont dans le même réseau et les IP sont uniques."
      },
      {
        look: "Deux routeurs partagent 192.168.1.0/30.",
        meaning: "Les seules IP hôtes sont .1 et .2.",
        deduction: "Chaque routeur utilise une extrémité du transit.",
        value: "R1 = 192.168.1.2/30 ; R2 = 192.168.1.1/30.",
        why: "Ils peuvent se remettre directement les paquets."
      },
      {
        look: "Le LAN C est 76.3.4.0/24.",
        ...
        value: "R1 : 76.3.4.0/24 via 192.168.1.1 ; R2 : 42.5.4.0/25 via 192.168.1.2.",
    ...
    beginnerFocus: [
      {
        ...
        steps: [
          "Le bloc 192.168.1.0/30 contient .0, .1, .2 et .3.",
          ".0 est le réseau et .3 le broadcast.",
          ".1 et .2 sont les deux seules IP utilisables.",
          "R1 utilise .2 et R2 .1.",
          "Les LAN de A/B, C et D utilisent d’autres blocs et ne se mélangent pas avec ce transit."
        ],
        result: "Transit : 192.168.1.0/30\nR13 : 192.168.1.2\nR21 : 192.168.1.1"
      },
      {
        ...
        steps: [
          "Un /25 couvre 128 adresses, ici 42.5.4.0 à 42.5.4.127.",
          ".0 est le réseau et .127 le broadcast.",
          "A .2, B .3 et R11 .1 sont trois adresses utilisables du même bloc.",
          "A et B peuvent atteindre directement leur gateway .1."
        ],
        result: "LAN A/B : 42.5.4.0/25\nA1 : .2\nB1 : .3\nR11 : .1"
      }
    ],
    solution: "LAN A/B : 42.5.4.0/25, gateway 42.5.4.1\nTransit : R1 192.168.1.2/30 <-> R2 192.168.1.1/30\nLAN C : 76.3.4.0/24, gateway 76.3.4.1\nLAN D : 113.187.64.0/18, gateway 113.187.77.249\nR1 route 76.3.4.0/24 via 192.168.1.1\nR1 route 113.187.64.0/18 via 192.168.1.1\nR2 default via 192.168.1.2",
    packet: ["A remet le paquet à sa gateway.", "R1 applique la route vers 76.3.4.0/24 et remet à R2.", "R2 livre à C.", "C répond à R2, qui applique sa route de retour vers 42.5.4.0/25."],
  ...
  "10": {
    ...
    deductions: [
      {
        look: "Toutes les adresses internes doivent tenir dans 130.137.107.0/24.",
      ...
      },
      {
        ...
        value: "Transit 130.137.107.252/30 : R2 .253, R1 .254.",
      ...
      },
      {
        ...
        value: "Internet : 130.137.107.0/24 via l’IP publique de R1.",
    ...
    beginnerFocus: [
      {
        ...
        steps: [
          "Le LAN H1-H2-R11 contient trois interfaces : 130.137.107.0/25 fournit largement assez de places.",
          "Le LAN H4-R23 utilise 130.137.107.128/26 : .128-.191.",
          "Le LAN H3-R22 utilise 130.137.107.192/27 : .192-.223.",
          "Le transit R13-R21 ne relie que deux interfaces : 130.137.107.252/30 suffit.",
          "Tous ces blocs sont différents et restent dans l’agrégat 130.137.107.0/24."
        ],
        result: "H1/H2/R11 : 130.137.107.0/25\nH4/R23 : 130.137.107.128/26\nH3/R22 : 130.137.107.192/27\nR1/R2 : 130.137.107.252/30"
      },
      {
        title: "Pourquoi .253 et .254 sur le transit /30 ?",
        intro: "Le dernier bloc /30 du /24 commence à .252.",
        steps: [
          "130.137.107.252/30 couvre .252 à .255.",
        ...
        result: "Transit : 130.137.107.252/30\nR21 : 130.137.107.253\nR13 : 130.137.107.254"
      }
    ],
    solution: "LAN H1/H2 : 130.137.107.0/25, R11 .1\nLAN H4 : 130.137.107.128/26, R23 .129, H41 .131\nLAN H3 : 130.137.107.192/27, R22 .193, H31 .194\nTransit : R21 .253/30 <-> R13 .254/30\nR2 default via 130.137.107.254\nR1 routes internes via 130.137.107.253\nR1 default via le voisin Internet\nInternet retour 130.137.107.0/24 via l’IP publique de R1",
